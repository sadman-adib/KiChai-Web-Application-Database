...
if (isset($_SESSION['username']) || isset($_SESSION['email'])) {
    ...
    $sql = "SELECT company_name, vendor_ID, phone, user_description, city FROM vendor WHERE email = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['kajchai']) && isset($_SESSION['vendor_id'])) {
    ...
    WHERE call_outs.vendor_id = ? AND call_outs.accept IS NULL AND call_outs.complete IS NULL";
    ...
    header("Location: http://localhost:3000/dashboard%20kaaj%20chai/index.php");
